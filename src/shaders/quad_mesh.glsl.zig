...
//
//  Cmdline: sokol-shdc -i quad_mesh.glsl -o quad_mesh.glsl.zig -l glsl330:metal_macos:hlsl4:glsl300es:wgsl -f sokol_zig
//
//  Overview:
//
//      Shader program 'quad':
...
// 
//
const vs_source_glsl330 = [217]u8 {
...
// 
//
const vs_source_glsl300es = [220]u8 {
...
// 
//
const vs_source_metal_macos = [432]u8 {
...
// 
// @vertex
// fn main(@location(0) position_1_param : vec3f, @location(2) color0_param : vec4f, @location(1) uv_param : vec2f) -> main_out {
...
const vs_source_wgsl = [717]u8 {
    ...
    0x0a,0x20,0x20,0x6c,0x65,0x74,0x20,0x78,0x5f,0x31,0x39,0x20,0x3a,0x20,0x76,0x65,
    ...
    0x3d,0x20,0x76,0x65,0x63,0x34,0x66,0x28,0x78,0x5f,0x31,0x39,0x2e,0x78,0x2c,0x20,
    0x78,0x5f,0x31,0x39,0x2e,0x79,0x2c,0x20,0x78,0x5f,0x31,0x39,0x2e,0x7a,0x2c,0x20,
    0x31,0x2e,0x30,0x66,0x29,0x3b,0x0a,0x20,0x20,0x6c,0x65,0x74,0x20,0x78,0x5f,0x33,
    0x30,0x20,0x3a,0x20,0x76,0x65,0x63,0x34,0x66,0x20,0x3d,0x20,0x63,0x6f,0x6c,0x6f,
    0x72,0x30,0x3b,0x0a,0x20,0x20,0x63,0x6f,0x6c,0x6f,0x72,0x20,0x3d,0x20,0x78,0x5f,
    ...
    0x20,0x63,0x6f,0x6c,0x6f,0x72,0x29,0x3b,0x0a,0x7d,0x0a,0x0a,0x00,
};
//
// diagnostic(off, derivative_uniformity);
// 
